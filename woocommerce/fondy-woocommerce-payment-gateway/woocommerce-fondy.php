...
function woocommerce_fondy_init()
{
    ...
    class WC_fondy extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->on_checkout_page = $this->settings['on_checkout_page'] ? $this->settings['on_checkout_page'] : '';
            $this->msg['message'] = "";
            $this->msg['class'] = "";
        ...
        function payment_fields()
        {
            ...
            if ($this->on_checkout_page == 'yes') {
                ...
                <form id="checkout_fondy_form">
                    ...
                    <?php
                    foreach ($this->on_checkout_fields() as $key => $field) {
                        ...
                        <div class="input-wrapper">
                            ...
                            <div class="input-field w-1">
                                <input required type="tel" name="card_number" class="input" id="fondy_ccard"
                                       ...
                                       maxlength="16" placeholder="<?= __('XXXXXXXXXXXXXXXX', 'woocommerce-fondy') ?>"/>
                                <div class="ccard"></div>
                            </div>
                        </div>
                        <div class="input-wrapper">
        ...
        function on_checkout_fields()
        {
            ...
            $fondy_args = array(
                ...
                'sender_email' => esc_attr($user_email)
            );
            return ($fondy_args);
        }
    ...
    add_action('wp_ajax_nopriv_generate_ajax_order_fondy_info', array('WC_fondy', 'generate_ajax_order_fondy_info'));
